...
private class FakeDashcamApi : DashcamApi {
    ...
    override suspend fun exitRecorder(): StringInfoResponse = error("Not used")
    override suspend fun setWifiSsid(ssid: String): StringInfoResponse = error("Not used")
    override suspend fun setWifiPassword(password: String): StringInfoResponse = error("Not used")
    override suspend fun wifiReboot(): StringInfoResponse = error("Not used")
    override suspend fun formatSdCard(index: Int): StringInfoResponse = error("Not used")
