...
object DashcamConstants {
    ...
    const val ENDPOINT_EXIT_RECORDER = "app/exitrecorder"
    const val ENDPOINT_SET_WIFI = "app/setwifi"
    const val ENDPOINT_WIFI_REBOOT = "app/wifireboot"
    const val ENDPOINT_SD_FORMAT = "app/sdformat"
